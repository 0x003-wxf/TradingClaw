# strategy-runtime-service/bootstrap/main.py 实现手顺

- 目标代码文件：`apps/strategy-runtime-service/src/tradingclaw_strategy_runtime/bootstrap/main.py`
...
## 实现顺序
1. 按文档为 `strategy-runtime-service` 注册角色：`event-consumer`、`temporal-worker`、`scheduler`、`migration-job`。
