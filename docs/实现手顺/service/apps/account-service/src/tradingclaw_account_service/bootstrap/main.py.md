# account-service/bootstrap/main.py 实现手顺

- 目标代码文件：`apps/account-service/src/tradingclaw_account_service/bootstrap/main.py`
...
## 实现顺序
1. 按文档为 `account-service` 注册角色：`http-api`、`grpc-api`、`event-consumer`、`migration-job`。
