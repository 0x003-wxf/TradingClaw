# capability-registry-service/bootstrap/main.py 实现手顺

- 目标代码文件：`apps/capability-registry-service/src/tradingclaw_capability_registry/bootstrap/main.py`
...
## 实现顺序
1. 按文档为 `capability-registry-service` 注册角色：`http-api`、`grpc-api`、`migration-job`。
