# market-service/bootstrap/main.py 实现手顺

- 目标代码文件：`apps/market-service/src/tradingclaw_market_service/bootstrap/main.py`
...
## 实现顺序
1. 按文档为 `market-service` 注册角色：`http-api`、`grpc-api`、`event-consumer`、`backfill-worker`、`scheduler`、`migration-job`。
