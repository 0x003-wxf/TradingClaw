# portfolio-calculation-service/bootstrap/main.py 实现手顺

- 目标代码文件：`apps/portfolio-calculation-service/src/tradingclaw_portfolio_calculation/bootstrap/main.py`
...
## 实现顺序
1. 按文档为 `portfolio-calculation-service` 注册角色：`grpc-api`。
