# ocr-service/bootstrap/main.py 实现手顺

- 目标代码文件：`apps/ocr-service/src/tradingclaw_ocr_service/bootstrap/main.py`
...
## 实现顺序
1. 按文档为 `ocr-service` 注册角色：`http-api`、`event-consumer`、`migration-job`。
