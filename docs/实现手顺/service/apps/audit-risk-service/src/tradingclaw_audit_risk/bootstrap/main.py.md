# audit-risk-service/bootstrap/main.py 实现手顺

- 目标代码文件：`apps/audit-risk-service/src/tradingclaw_audit_risk/bootstrap/main.py`
...
## 实现顺序
1. 按文档为 `audit-risk-service` 注册角色：`http-api`、`grpc-api`、`event-consumer`、`migration-job`。
