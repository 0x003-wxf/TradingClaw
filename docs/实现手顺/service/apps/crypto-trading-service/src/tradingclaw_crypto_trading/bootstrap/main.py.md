# crypto-trading-service/bootstrap/main.py 实现手顺

- 目标代码文件：`apps/crypto-trading-service/src/tradingclaw_crypto_trading/bootstrap/main.py`
...
## 实现顺序
1. 按文档为 `crypto-trading-service` 注册角色：`grpc-api`、`adapter-worker`、`event-consumer`、`scheduler`、`migration-job`。
