# notification-service/bootstrap/main.py 实现手顺

- 目标代码文件：`apps/notification-service/src/tradingclaw_notification/bootstrap/main.py`
...
## 实现顺序
1. 按文档为 `notification-service` 注册角色：`event-consumer`、`scheduler`、`migration-job`。
