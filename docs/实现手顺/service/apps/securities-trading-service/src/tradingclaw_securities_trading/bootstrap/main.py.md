# securities-trading-service/bootstrap/main.py 实现手顺

- 目标代码文件：`apps/securities-trading-service/src/tradingclaw_securities_trading/bootstrap/main.py`
...
## 实现顺序
1. 按文档为 `securities-trading-service` 注册角色：`grpc-api`、`adapter-worker`、`event-consumer`、`migration-job`。
