# strategy-service/bootstrap/main.py 实现手顺

- 目标代码文件：`apps/strategy-service/src/tradingclaw_strategy_service/bootstrap/main.py`
...
## 实现顺序
1. 按文档为 `strategy-service` 注册角色：`http-api`、`grpc-api`、`migration-job`。
