# news-service/bootstrap/main.py 实现手顺

- 目标代码文件：`apps/news-service/src/tradingclaw_news_service/bootstrap/main.py`
...
## 实现顺序
1. 按文档为 `news-service` 注册角色：`http-api`、`event-consumer`、`backfill-worker`、`scheduler`、`migration-job`。
