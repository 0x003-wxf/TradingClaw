# ai-orchestration-service/bootstrap/main.py 实现手顺

- 目标代码文件：`apps/ai-orchestration-service/src/tradingclaw_ai_orchestration/bootstrap/main.py`
...
## 实现顺序
1. 按文档为 `ai-orchestration-service` 注册角色：`http-api`、`grpc-api`、`event-consumer`、`migration-job`。
